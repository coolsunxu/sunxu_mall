...
public interface CommonNotifyEntityMapper {
     ...
     * @return 通知实体
     */
    CommonNotifyEntity selectByBizKey(@Param("bizKey") String bizKey);
     ...
     * @return 影响行数
     */
    int tryLockForPushByBizKey(@Param("bizKey") String bizKey);
     ...
     * @return 影响行数
     */
    int markPushSentByBizKey(@Param("bizKey") String bizKey);
     ...
     * @return 影响行数
     */
    int markPushFailedAndRetryByBizKey(@Param("bizKey") String bizKey,
                                       @Param("errorMsg") String errorMsg,
                                       @Param("nextRetryTime") java.time.LocalDateTime nextRetryTime);
     ...
     * @return 影响行数
     */
    int markPushDeadByBizKey(@Param("bizKey") String bizKey, @Param("errorMsg") String errorMsg);
}